        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessonStartTime = table.Column<TimeOnly>(type: "time without time zone", nullable: true),
                    LessonEndTime = table.Column<TimeOnly>(type: "time without time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Groups_Teachers_MentorId",
                        column: x => x.MentorId,
